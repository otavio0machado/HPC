        ...
        <div className="w-64 flex flex-col border-r border-zinc-800 bg-[#18181b] z-10 flex-shrink-0">
            <div className="p-3 border-b border-zinc-800 flex justify-between items-center">
                ...
                <div className="flex gap-1">
                    <button onClick={() => setCreationModal({ isOpen: true, type: 'folder', parentId: null })} className="p-1 hover:bg-zinc-800 rounded text-zinc-400" title="Nova Pasta"><FolderPlus size={14} /></button>
                    <button onClick={() => setCreationModal({ isOpen: true, type: 'markdown', parentId: null })} className="p-1 hover:bg-zinc-800 rounded text-zinc-400" title="Nova Nota"><Edit3 size={14} /></button>
                    <button onClick={() => fileInputRef.current?.click()} className="p-1 hover:bg-zinc-800 rounded text-zinc-400" title="Upload PDF"><Upload size={14} /></button>
                </div>
            </div>
                    ...
                    {activePdf.pdfData && (
                        <>
                            ...
                            <button
                                ...
                                className="absolute left-4 top-1/2 -translate-y-1/2 z-30 p-3 bg-black/50 hover:bg-black/80 text-white rounded-full transition-all disabled:opacity-0 disabled:pointer-events-none transform hover:scale-110 shadow-lg backdrop-blur-sm"
                            ...
                            <button
                                ...
                                className="absolute right-6 top-1/2 -translate-y-1/2 z-30 p-3 bg-black/50 hover:bg-black/80 text-white rounded-full transition-all disabled:opacity-0 disabled:pointer-events-none transform hover:scale-110 shadow-lg backdrop-blur-sm"
                    ...
                    {textSelection && (
                        ...
                        >
                            <button 
                                ...
                                className="bg-blue-600 text-white text-xs font-bold py-1.5 px-3 rounded-full shadow-xl flex items-center gap-1 hover:bg-blue-500 hover:scale-105 transition-all animate-in zoom-in"
                            >
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl w-80 shadow-2xl animate-in zoom-in-95">
                  ...
                  <form onSubmit={handleCreateSubmit}>
                      ...
                      <div className="flex gap-2">
                          <button type="button" onClick={() => setCreationModal({ ...creationModal, isOpen: false })} className="flex-1 py-2 text-zinc-400 hover:text-white">Cancelar</button>
