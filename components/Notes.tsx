      ...
      <div className="w-72 flex flex-col border-r border-white/5 bg-black/10 z-10 flex-shrink-0 backdrop-blur-xl">
        <div className="p-3 border-b border-zinc-800 flex justify-between items-center">
          ...
          <div className="flex gap-1.5">
            ...
            <button onClick={() => fileInputRef.current?.click()} className="p-1.5 hover:bg-white/10 rounded-lg text-zinc-400 hover:text-white transition-all border border-transparent hover:border-white/10 bubble-hover" title="Upload PDF"><Upload size={14} /></button>
          </div>
        </div>
      ...
      {activeNote ? (
        ...
        !activePdf && (
          <div className="flex-1 flex flex-col items-center justify-center text-zinc-600 bg-zinc-950/50">
            ...
            <p className="text-sm max-w-sm text-center text-zinc-400 leading-relaxed">Abra uma nota e um PDF simultaneamente para citar e estudar com alta performance.</p>
          </div>
        )
      )}
