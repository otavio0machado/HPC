            ...
            <div className="md:col-span-1 space-y-6">
               <div className="glass-hydro rounded-3xl p-8 flex flex-col items-center text-center relative overflow-hidden group">
                  ...
                  <div className="relative mb-6 group cursor-pointer">
                     <div className="w-32 h-32 rounded-full bg-zinc-100 dark:bg-zinc-950 border-4 border-zinc-200 dark:border-zinc-900 flex items-center justify-center text-4xl font-bold text-zinc-900 dark:text-white shadow-2xl relative z-10 overflow-hidden">
                     ...
                     <div className="absolute bottom-1 right-1 p-2 bg-blue-600 hover:bg-blue-500 rounded-full text-white shadow-lg border-4 border-zinc-200 dark:border-zinc-900 transition-transform hover:scale-110 z-20">
                        <Camera size={16} />
                     </div>
                  </div>
               ...
               <div className="glass-hydro rounded-3xl p-6 relative overflow-hidden">
                  ...
                  {isPro ? (
                     <button
                        ...
                        className="w-full py-3 border border-zinc-200 dark:border-white/10 hover:bg-zinc-100 dark:hover:bg-white/5 text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-colors flex items-center justify-center gap-2 backdrop-blur-md bg-white/[0.02]"
                     >
                        {isLoadingTier ? <span className="animate-spin rounded-full h-4 w-4 border-b-2 border-zinc-600 dark:border-white"></span> : 'Gerenciar Assinatura'}
                     </button>
                  ) : (
                     <button
                        onClick={() => setShowUpgradeModal(true)}
                        className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all shadow-lg shadow-blue-900/40 flex items-center justify-center gap-2 group border border-blue-700 dark:border-white/10 backdrop-blur-md"
                     >
            ...
            <div className="md:col-span-2 space-y-6">
               <div className="glass-hydro rounded-3xl p-8">
                  <div className="flex justify-between items-center mb-8">
                     ...
                     {!isEditing && (
                        <button
                           ...
                           className="text-xs font-bold text-blue-400 hover:text-white bg-blue-500/10 hover:bg-blue-500 px-4 py-2 rounded-lg transition-all border border-blue-500/20 backdrop-blur-md"
                        >
                           Editar Informações
                        </button>
                     )}
                  ...
                  <form onSubmit={handleSave} className="space-y-6">
                     ...
                     {isEditing && (
                        <div className="flex items-center gap-3 pt-6 border-t border-zinc-200 dark:border-white/5 mt-4">
                           <button
                              type="button"
                              onClick={() => {
                                 setIsEditing(false);
                              ...
                              className="px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white rounded-xl text-sm font-bold transition-colors border border-transparent hover:border-zinc-600 backdrop-blur-md"
                           >
                              Cancelar
                           </button>
                           <button
                              type="submit"
                              className="px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-sm font-bold shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2 transition-transform hover:scale-[1.02] backdrop-blur-md border border-white/20"
                           >
               ...
               <div className="bg-red-500/5 border border-red-500/10 rounded-3xl p-8 backdrop-blur-sm">
                  <div className="flex items-start gap-4">
                     ...
                     <div className="flex-1">
                        ...
                        <button className="text-xs font-bold uppercase tracking-wider text-red-400 hover:text-white bg-red-500/10 hover:bg-red-500 border border-red-500/20 hover:border-red-500 px-6 py-3 rounded-xl transition-all backdrop-blur-md shadow-lg shadow-red-900/10">
